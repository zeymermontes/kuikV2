...
/** Super-admin editor for the platform subscription price. */
export function PricingSettings({ settings }: { settings: PlatformSettings }) {
  ...
  function save() {
    ...
    startTransition(async () => {
      await updatePricing(Number(amount), currency, name);
      setSaved(true);
    });
  }
  ...
  return (
    <Card>
      <h2 className="mb-4 font-semibold">Precio de la suscripción</h2>
